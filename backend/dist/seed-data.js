...
exports.createSeedContentSnapshot = exports.demoPassword = void 0;
exports.createSeedUsers = createSeedUsers;
exports.createSeedSnapshot = createSeedSnapshot;
const bcryptjs_1 = __importDefault(require("bcryptjs"));
exports.demoPassword = 'AfriStory2026!';
const portraitUrls = [
...
const demoPasswordHash = bcryptjs_1.default.hashSync(exports.demoPassword, 10);
...
function createAvatarUrl(index) {
    return portraitUrls[index % portraitUrls.length];
}
function createCoverUrl(index) {
...
function makeComment(author, text, time, avatarUrl) {
...
function createSeedSnapshot(users) {
...
exports.createSeedContentSnapshot = createSeedSnapshot;
